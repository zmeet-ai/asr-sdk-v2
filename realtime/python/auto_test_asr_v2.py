...
if __name__ == "__main__":
    ...
    parser.add_argument('--audio_file',
                       type=str,
                       default=os.path.join(os.path.dirname(__file__), "../dataset/asr/1002_20241126_231435_full_audio.wav"),
                       help='Path to the audio file (default: ../dataset/asr/1002_20241126_231435_full_audio.wav)')
